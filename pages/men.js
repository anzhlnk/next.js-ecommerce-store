...
export default function ListTshirtsMen(props) {
  const menTshirts = props.productDatabase.filter((tshirt) => {
    return tshirt.category === 'man';
  });
  console.log('for men', menTshirts);
  let isAvailable = false;
  return (
    <>
      <Head>
        <title>Men T-shirts | orange orange</title>
        <meta name="description" content="Men T-shirts" />
      </Head>
      <div css={contentAll}>
        <div css={heading}>
          <Link href="/">
